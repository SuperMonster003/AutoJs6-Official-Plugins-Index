...
file as absent and defaulting its version or dropping artifact admission data.
...
Paddle OCR PP-OCRv6 features only the Small distribution by default. Tiny and
Medium remain indexed with their published APKs as optional distributions.
